        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true"
            ...
            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                ...
                <div class="menu-item">
                    ...
                    <span class="menu-link">
                        ...
                        <span class="menu-title"><a href="{{route('home')}}">Dashboards</a></span>
                    </span>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu sub-->
            ...
            <div data-kt-menu-trigger="click"
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Request::segment(2) == 'booking' && Request::segment(3) == 'refund' ? 'active': ''; }}"
                            href="">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Cancenllation & Refund</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                </div>
            ...
            <div data-kt-menu-trigger="click"
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Request::segment(2) == 'employee' && Request::segment(3) == 'new' ? 'active': '' }}"
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Request::segment(2) == 'employee' && Request::segment(3) == 'list' ? 'active': '' }}"
