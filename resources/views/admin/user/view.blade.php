...
<div id="kt_app_content_container" class="app-container container-xxl">
    ...
    <div class="d-flex flex-column flex-lg-row">
        <!--begin::Sidebar-->
        <div class="flex-column flex-lg-row-auto w-lg-250px w-xl-550px mb-10">
            <!--begin::Card-->
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <div class="symbol symbol-100px symbol-circle mb-7">
                            <img src="{{ Avatar::create($getDetails->name)->toBase64() }}" alt="image" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Name-->
                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{$getDetails->name}}</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="mb-9">
                            <!--begin::Badge-->
                            <div class="badge badge-lg badge-light-primary d-inline">{{$getDetails->role}}</div>
                            <!--begin::Badge-->
                        </div>
                    </div>
                    <!--end::User Info-->
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">ID-{{$getDetails->member_id}}</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Email</div>
                            <div class="text-gray-600">
                                <a href="#" class="text-gray-600 text-hover-primary">{{$getDetails->email}}</a>
                            </div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Address</div>
                            <div class="text-gray-600">Not Available
                            </div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            ...
                            <div class="text-gray-600">21 Feb 2023, 11:30 am</div>
                            <!--begin::Details item-->
                        </div>
                    </div>
                    <!--end::Details content-->
