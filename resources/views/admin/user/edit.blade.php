...
<div class="app-container container-xxl">
    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <div class="card card-body flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
            <!--begin::Form-->
            <form class="form p-10" action="{{route('user.update',['id' => $getUser->id])}}" method="post">
                @csrf
                <input type="hidden" name="member_id" value="{{ $getUser->member_id }}" />
                <div class="fv-row mb-9">
                    ...
                    <select class="form-select" name="name" data-control="select2" disabled>
                        @foreach($staffMember as $staffMembers)
                        <option value="{{ $staffMembers->full_name }}"
                            {{ $staffMembers->full_name == $getUser->name ? 'selected' : '' }}>
                            {{$staffMembers->full_name}}</option>
                        @endforeach
                    </select>
                    <!--end::Input-->
                </div>
                ...
                <div class="fv-row mb-9">
                    ...
                    <select class="form-select" name="role" data-control="select2">
                        ...
                        <option value="{{ $role->name }}" {{ $role->name == $getUser->role ? 'selected' : '' }}>
                            {{$role->name}}</option>
                        @endforeach
                    </select>
                    <!--end::Input-->
